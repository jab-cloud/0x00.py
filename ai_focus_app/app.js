...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderGoals() {
        ...
        if (goals.length === 0) {
            ...
            li.textContent = "No goals set. Add one to get started!";
            li.className = 'small';
    ...
    function renderBlockedList() {
        ...
        if (blockedApps.length === 0) {
            const li = document.createElement('li');
            li.textContent = "No apps blocked. You're in control!";
            li.className = 'small';
            li.style.justifyContent = 'center';
    ...
    [goalInput, blockInput, challengeAnswerEl].forEach(input => {
        input.addEventListener('keydown', (e) => {
            if (e.key === 'Enter') {
                if (input === goalInput) addGoalBtn.click();
                if (input === blockInput) addBlockBtn.click();
                if (input === challengeAnswerEl) verifyChallengeBtn.click();
            }
        });
    });
